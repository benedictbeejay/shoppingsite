...
//       <div className="w-full flex h-full transition-all ease-in-out duration-1000">
//         {slides.map((slide) => {
    ...
    <div className="h-[calc(100vh-80px)] overflow-hidden ">
      ...
      >
        {slides.map((slide) => (
          ...
          >
            {/* Text container */}
            <div className="h-1/2 lg:h-full lg:w-1/2 flex items-center justify-center gap-8 flex-col 2xl:gap-12 text-center">
